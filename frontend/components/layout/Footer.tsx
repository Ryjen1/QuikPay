...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/LFGBanditLabs/QuikPay",
    icon: (
  ...
  {
    label: "Twitter / X",
    href: "https://twitter.com/QuikPay",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          <div className="lg:col-span-2">
             <div className="flex items-center gap-2 mb-4">
              <div className="flex items-center justify-center w-10 h-10 rounded-2xl bg-gradient-to-br from-[var(--accent)] to-[var(--token-color-brand-700)] text-white font-black text-[0.8rem] tracking-[0.18em] shadow-lg">
                QP
              </div>
              <span className="text-xl font-bold tracking-[-0.03em] text-[var(--text)]">
                QuikPay
              </span>
            </div>
