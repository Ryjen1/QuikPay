...
const envSchema = z.object({
  ...
  VITE_PAYROLL_STREAM_CONTRACT_ID: z.string().optional(),
  VITE_PAYROLL_VAULT_CONTRACT_ID: z.string().optional(),
  VITE_WORKFORCE_REGISTRY_CONTRACT_ID: z.string().optional(),
  VITE_AUTOMATION_GATEWAY_CONTRACT_ID: z.string().optional(),
});
