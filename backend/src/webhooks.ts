...
import { verifyQuikPaySignature } from "./middleware/security";
 ...
 * @apiDescription Subscribes an endpoint to receive real-time notifications for QuikPay events.
 */
webhookRouter.post(
  "/",
  webhookRegistrationLimiter,
