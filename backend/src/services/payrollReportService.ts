...
const SENDGRID_FROM_EMAIL =
  process.env.SENDGRID_FROM_EMAIL || "noreply@quikpay.com";
  ...
  try {
    ...
    await axios.post(
      "https://api.sendgrid.com/v3/mail/send",
      {
        ...
        from: { email: SENDGRID_FROM_EMAIL, name: "QuikPay Payroll" },
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>This is an automated report from QuikPay Payroll System.</p>
