...
export class AIGateway {
  ...
  async parseCommand(command: string): Promise<AICallResponse> {
    ...
    const systemPrompt = `
You are an AI assistant for QuikPay, a payroll management system on the Stellar network.
Your task is to parse natural language commands into structured JSON calls for the QuikPay payroll contract.
