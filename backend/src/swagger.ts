...
const swaggerDefinition = {
  openapi: "3.0.3",
  info: {
    title: "QuikPay Automation Engine API",
    version: "1.0.0",
    description:
      "REST API for the QuikPay payroll automation backend. Covers health, metrics, scheduler, treasury monitor, webhooks, Slack/Discord integrations, AI command parsing, analytics, and admin RBAC endpoints.",
    contact: {
      name: "QuikPay Team",
      url: "https://github.com/bakarezainab/QuikPay",
    },
    license: {
      name: "ISC",
    },
    ...
    schemas: {
      ...
      HealthResponse: {
        ...
        properties: {
          ...
          service: {
            type: "string",
            example: "quikpay-automation-engine",
          },
          dependencies: {
            type: "object",
            properties: {
      ...
      WebhookSubscription: {
        ...
        properties: {
          ...
          url: {
            type: "string",
            format: "uri",
            example: "https://example.com/hooks/quikpay",
          },
          events: {
            type: "array",
            items: { type: "string" },
  ...
  paths: {
    ...
    "/slack/command": {
      post: {
        ...
        description:
          "Handles `/quikpay` slash commands sent from Slack. Supports the `status` sub-command which returns current treasury balance and liability.",
  ...
  tags: [
    ...
    {
      name: "Webhooks",
      description: "Subscribe external endpoints to QuikPay events.",
    },
    {
      name: "Integrations",
...
docsRouter.get(
  ...
  swaggerUi.setup(swaggerSpec, {
    customSiteTitle: "QuikPay API Docs",
    swaggerOptions: {
